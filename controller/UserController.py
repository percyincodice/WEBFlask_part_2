...
def createUser(decoded_token=None):
    try:
...
@validation_token.token_required
def listUser(decoded_token=None):
    try:       
...
def updatePassword(decoded_token):
    try:       
        ...
        print("Error update password:", e) # cloudwatch aws
        return "Error update password.", 500
